...
for i_cell = nstart:numCells
    ...
    if load_this
        ...
        for input_cycle = 1:4
            ...
            [result_binspikes, current_idx, other_idx]  = bin_spike_4_PEV_cur_and_othr_tg_1stTrlExcd_nonPfct(...
                t_spike,...
                t_trig,...
                TrialID,...
                width,...
...
save Results_CurrVsOtherTarg_PEV_nonPerfectTrls_dv_pfc binned_data binned_labels binned_site_info trial_Data
